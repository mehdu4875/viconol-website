              ...
              <div className="py-2 pl-16 pr-4 flex flex-col gap-1">
                {categories.map((cat) => (
                  <Link 
                    ...
                    href={`/${locale}/products?cat=${cat.id}`} 
                    onClick={closeMenu}
                    className="block py-3 text-sm text-gray-400 hover:text-white hover:pl-2 transition-all border-l-2 border-transparent hover:border-viconol-primary uppercase tracking-widest"
                  >
                    {getCatName(cat.name)}
                  </Link>
                ))}
                <Link 
                  ...
                  onClick={closeMenu}
                  className="block py-3 text-sm font-bold text-viconol-primary hover:text-white hover:pl-2 transition-all mt-2 uppercase tracking-widest"
                >
                  {t('all_catalogue')} →
                </Link>
              </div>
